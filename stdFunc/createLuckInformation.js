...
var luckyPetsList = ["发条月亮","魔法水桶","手指光标","迷你命名威","小熊猫","青鸟","南方度假獭獭","触手","祭礼鲶鱼精","鲨鱼指挥官","巴哈姆特之型","白鼬","蓝闪蝶","小树袋熊","食果花鼠","莫莫拉·莫拉！！！","蝴蝶效应","衣匠猴面雀儿","宝宝箱","虎斑次郎","发条提灯","常风王子","獭獭","小妖狐","迷你斯卡哈","淘气南加","发条卫月","小脚雪人","喜鹊儿","恩奇都","凯西幼苗","朱孔雀","椒盐海豹","复活小天使","草小人","阿马罗宝宝","水小滴","黄金大河狸","肥肥风筝猫","辅助机316","多玛金鱼儿","狐獴","小刺猬","迷你巨人掌","猪小仙","叮叮摇铃","奇塔利的水蛇？","得到宽恕的仇恨","小雪童子","魔法扫帚","企鹅王子","猫头小鹰","萌神乐团","分福","吉吉","浅瞳","白小虎","月读之形","银山雀儿","小小冰海天使","黑豆柴","仙子人偶","亚拉戈西瓜","拉拉鳄","啦哩吼矮人","猫秘玩偶","大哥布林人偶","小鸭嘴兽","泥小点","迷你欧米茄","阳小灵","夺心小魔","魔菇宝","聪慧小海豚","海小鸥","魔导猎手追踪型","本本石","浪人的篝火","三角龙龙","迷你盖娅","莫莫拉·莫拉！！！","机械生物","烹饪猴面雀儿","沙狐","小小食蚁兽","软软垫子","卡尔克","雪孩子"];
...
var greateLuckPoem = ["雾之始源，远古之皇。","峡湾掠影，奇异微光。","古老秘族，不朽传说。","乌云密布，深渊诡影。","瑰丽城下，镜中梦幻。","广袤沙海，诡异目光。"]
var luckPoem = ["万云雷去，赤红之鳞。","王中帝皇，提蒙门前。","闺中怨怼，声声如镰。","雷印咸湖，宛如天工。","七彩虹光，东方宸曜。","苍茫大地，黎明波光。"];
var smallLuckPoem = ["天地易位，子时微萤。","未知其名，熔火诡影。","雷鸣连天，难言其形。","清澈如冰，恶臭袭心。","浮之离岛，实之吾幸。","惋惜苍风，暗流涌动。"];
